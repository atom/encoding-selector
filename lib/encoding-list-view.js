...
export default class EncodingListView {
    ...
    this.selectListView = new SelectListView({
      ...
      didConfirmSelection: (encoding) => {
        ...
        if (encoding.id === 'detect') {
          ...
          editor.detectEncoding().then((encoding) =>
            editor.setEncoding(encoding || atom.config.get('core.fileEncoding'))
          ).catch(() => editor.setEncoding(atom.config.get('core.fileEncoding')))
        } else {
